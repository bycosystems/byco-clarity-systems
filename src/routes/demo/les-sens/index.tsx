// ─────────────────────────────────────────────────────────────
// src/routes/demo/les-sens/index.tsx
// "Éveil Digital" — démo mini-application pour Les Sens · Nice
// Conçue par ByCo Systems. Démonstration personnalisable.
//
// DÉPLOIEMENT :
//   1. Placer ce fichier dans  src/routes/demo/les-sens/index.tsx
//   2. Placer le PDF comparatif dans  public/demo/les-sens/comparatif.pdf
//   3. git add . && git commit && git push  → Cloudflare Pages déploie
//   4. URL publique : https://bycosystems.xyz/demo/les-sens
//
...
export const Route = createFileRoute("/demo/les-sens/")({
  component: EveillDigital,
  head: () => ({
    meta: [
      { title: "Les Sens · Éveil Digital × ByCo Systems" },
      {
        name: "description",
        content:
...
const PHOTOS = [
  "https://les-sens-nice.fr/wp-content/uploads/2025/12/Capture-decran-2021-05-13-a-19.10.07.png",
  "https://les-sens-nice.fr/wp-content/uploads/2025/12/Capture-decran-2021-05-13-a-18.58.15.png",
  "https://les-sens-nice.fr/wp-content/uploads/2025/12/Capture-decran-2021-05-13-a-18.56.31.png",
  "https://les-sens-nice.fr/wp-content/uploads/2025/12/Capture-decran-2021-05-13-a-19.00.36.png",
  "https://les-sens-nice.fr/wp-content/uploads/2025/12/Capture-decran-2021-05-13-a-18.59.15.png",
  "https://les-sens-nice.fr/wp-content/uploads/2025/12/Capture-decran-2021-05-13-a-19.03.08.png",
  "https://les-sens-nice.fr/wp-content/uploads/2025/12/Capture-decran-2021-05-13-a-19.07.14.png",
  "https://les-sens-nice.fr/wp-content/uploads/2025/12/Capture-decran-2021-05-13-a-19.06.04.png",
];

const LOGO = "https://les-sens-nice.fr/wp-content/uploads/2025/12/logo.png";
  ...
  return (
    <div style={{ paddingBottom: 28 }}>
      ...
      <div style={{ position: "relative" }}>
        <SafeImg
          src={PHOTOS[0]}
          alt="Les Sens · Salle du restaurant"
          style={{
            width: "100%",
            height: 220,
            objectFit: "cover",
        ...
        >
          © Les Sens Nice — votre visuel dans votre application
        </div>
      </div>
      ...
      <div style={{ padding: "20px 22px 0" }}>
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 11.5, color: C.terracotta, marginTop: 4 }}>
              ★ 4.7 · 1 774 avis Google
            </div>
          </div>
        </div>
      </div>
        ...
        {(activeFilter === "Tous") && (
          ...
          >
            ...
            <div style={{ marginBottom: 14, borderRadius: 10, overflow: "hidden", position: "relative" }}>
              <SafeImg
                src={PHOTOS[3]}
                alt="Plat du menu de la semaine"
                style={{
                  width: "100%",
                  height: 120,
                  objectFit: "cover",
...
function MaTable({
  ...
  return (
    <div style={{ padding: "22px 22px 28px" }}>
      ...
      {tableAction === "retard" && (
        <Banner tone="ok">
          Retard signalé à l'équipe Les Sens, merci.
        </Banner>
      )}
  ...
  return (
    <div style={{ padding: "22px 22px 28px" }}>
      ...
      >
        ...
        >
          © Photos Les Sens Nice — intégrées avec leur accord lors du déploiement final
        </div>
      </div>
    </div>
  );
...
function SafeImg({
  ...
  if (error) {
    return <div style={fallbackStyle} aria-label={alt} />;
  }
  return (
    <img
      src={src}
